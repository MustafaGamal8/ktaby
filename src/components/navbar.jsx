    ...
    return ( 
        <nav className='select-none'>
                <div className='flex items-center justify-between p-5 bg-white drop-shadow-sm h-16 '>
                    ...
                    <h1 className='text-2xl font-semibold'><FontAwesomeIcon icon={faBook} className='text-green-400 mr-2' /> كتابي</h1>
                ...
                <ul className='flex flex-row-reverse justify-around whitespace-nowrap items-center bg-green-500 h-12 text-white md:text-lg drop-shadow-xl relative'>
                    ...
                    <li className='hover:bg-white hover:text-green-500 rounded-md p-2 transition-all duration-300 cursor-pointer' >مواقع اخري</li>
                    <li className='hover:bg-white hover:text-green-500 rounded-md p-2 transition-all duration-300 cursor-pointer' ><FontAwesomeIcon icon={faQuestion} className="fa-flip-horizontal mr-2" />من نحن </li>
                </ul>
                {subMenu &&
                    <div  className=' transition-all pt-2 w-full rounded bg-white drop-shadow-2xl'>
                        <ul  className=' flex flex-col  flex-wrap h-48 w-full gap-1 bg-white' style={{ direction: 'rtl', textAlign: 'right' }}>
                            <li className='bg-green-500 text-white text-center hover:scale-125 duration-500 '>كل الكتب</li>

...
const NavBar = () => {
    ...
    let menuSections = ["إدارة أعمال", "تكنولوجيا", 'تاريخ', 'اقتصاد', 'أديان', 'أدب رحلات', 'أدب', 'جغرافيا', 'صحة', 'شعر', 'سير الأعلام', 'خيال علمي', 'علوم', 'علم نفس', 'علوم اجتماعية ', 'علوم البيئة', 'علوم اللغة', 'فلسفة', 'فنون', 'قصص الأطفال', 'قصص بوليسية', 'مسرحيات', 'نقد أدبي', 'روايات ']
